...
namespace MainBoilerPlate.Migrations
{
    ...
    [Migration("20250926165158_reset-new")]
            ...
            modelBuilder.Entity("MainBoilerPlate.Models.RoleApp", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 26, 16, 51, 58, 37, DateTimeKind.Unspecified).AddTicks(7869), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 26, 16, 51, 58, 37, DateTimeKind.Unspecified).AddTicks(7887), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 26, 16, 51, 58, 37, DateTimeKind.Unspecified).AddTicks(7892), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Teacher",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 9, 26, 16, 51, 58, 37, DateTimeKind.Unspecified).AddTicks(7901), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Student",
